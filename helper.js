...
exports.mergeNameStr = function(line) {
  return line.replace(',', '').replace('""', ' ')
}
exports.mergeNameArr = function(line) {
  let newline = line[0] + ' ' + line[1]
  line.splice(0, 2, newline)
  return line
}
...
exports.logToS3 = function(data, callback) {
  ...
  setTimeout(() => {
    ...
    s3.putObject({
      ...
      callback(err ? err : surprise('log-to-s3'), {
        data,
        logged: true
      })
    })
